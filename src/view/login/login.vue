        ...
        if(code==null||code==""){
          ...
          this.$axios.post(this.domain.ssoserverpath+"login",par).then((response)=>{
            ...
            if(respo.code==200){
              ...
              this.$store.state.userInfo=response.data.resuit
              ...
              this.$router.push({path:'/view/shouye/shouye',query:{username:response.data.resuit.userName,userid:response.data.resuit.id}});
